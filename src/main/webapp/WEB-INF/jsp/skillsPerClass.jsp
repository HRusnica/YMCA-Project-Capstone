...
<html lang="en">
  <head>
    ...
    <title>View All Class Skills</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">View All Class Skills</h1>

       

          <h2 class="sub-header">Student Skill List</h2>
          <div class="table-responsive">
            <table class="table table-striped">
              <thead>
                <tr>
                <c:forEach items="${allStudents}" var="student">
                  <th><c:out value="${student.firstName }" /> s <c:out value="${student.lastName }" /></th>
                 
                  </c:forEach>
                </tr>
              </thead>
              <tbody>
              <c:forEach items="${allClassSkills}" var="skills">
                <tr>
